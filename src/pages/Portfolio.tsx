...
export default function Portfolio() {
  ...
  const projects = [
    { id: 1, title: 'Moqah.pk', description: 'Event discovery and ticketing platform allowing organizers to list events and customers to purchase tickets seamlessly.', category: 'web-mobile', technologies: ['Web App', 'Payment', 'Event Management'], year: 2022 },
    { id: 2, title: 'Karvaan', description: 'SaaS platform for tour agencies managing operations, streamlining workflows, and improving operational efficiency.', category: 'web-mobile', technologies: ['Desktop App', 'SaaS', 'Operations'], year: 2022 },
    { id: 3, title: 'SmartScout', description: 'Mobile app connecting football players and scouts with real-time notifications and activity tracking.', category: 'web-mobile', technologies: ['React Native', 'Mobile', 'Sports Tech'], year: 2022 },
