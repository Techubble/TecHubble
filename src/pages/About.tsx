...
const founders = [
  ...
  { name: 'Huzaifa', role: 'Co-Founder & ML Engineer', bio: 'Machine learning specialist focused on AI-driven solutions and data science innovations.', expertise: ['Machine Learning', 'Data Science', 'AI Systems'], initials: 'HU', color: '#f5c518', bg: '#f5c518' },
];
